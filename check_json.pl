...
#
# original: https://github.com/c-kr/check_json
# sadly its olad and outdated and the don't merge MRs, so we had to change the code our self
# 2024-06-18 replaced 'Nagios::Plugin' with 'Monitoring::Plugin'
#
